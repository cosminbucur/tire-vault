            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative flex h-12 items-center gap-3 rounded-full hover:bg-accent/50 px-2 transition-colors focus:outline-none group">
                <Avatar className="h-9 w-9 border-2 border-primary/10 shadow-sm transition-transform group-hover:scale-105">
                  ...
                  <AvatarFallback className="bg-primary/10 text-primary font-bold">CB</AvatarFallback>
                </Avatar>
                <div className="hidden md:flex flex-col items-start transition-opacity group-hover:opacity-80">
                  <span className="text-sm font-semibold leading-none">Cosmin Bucur</span>
                  <span className="text-[11px] text-muted-foreground mt-0.5">cosmin.bucur@mambu.com</span>
                </div>
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent className="w-56" align="end" forceMount>
              <DropdownMenuLabel className="font-normal">
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-semibold leading-none">Cosmin Bucur</p>
                  <p className="text-xs leading-none text-muted-foreground">
                    cosmin.bucur@mambu.com
                  </p>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem className="text-destructive focus:text-destructive cursor-pointer font-medium">
